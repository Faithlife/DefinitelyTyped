// Type definitions for node-mysql2
// Project: https://github.com/sidorares/node-mysql2
// Definitions by: William Johnston <https://github.com/wjohnsto>, Dave Dunkin <http://github.com/ddunkin>
...
declare module "mysql2" {
    ...
    interface IQueryFunction {
        ...
        (sql: string, callback: (err: IError, results: IResultSet) => void): IQuery;
        (sql: string, values: Array<any>): IQuery;
        (sql: string, values: Array<any>, callback: (err: IError, ...args: any[]) => void): IQuery;
        (sql: string, values: Array<any>, callback: (err: IError, results: IResultSet) => void): IQuery;
        (sql: string, values: any): IQuery;
        (sql: string, values: any, callback: (err: IError, ...args: any[]) => void): IQuery;
        (sql: string, values: any, callback: (err: IError, results: IResultSet) => void): IQuery;
    ...
    interface IResultSet extends Array<any> {
        /**
